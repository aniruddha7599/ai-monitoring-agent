...
Backend	<img src="https://img.shields.io/badge/FastAPI-0.110-green?logo=fastapi" alt="FastAPI" />	High-performance REST API
Database	<img src="https://img.shields.io/badge/PostgreSQL-15-blue?logo=postgresql" alt="PostgreSQL" /> & SQLAlchemy	Data storage and ORM
Containerization	<img src="https://img.shields.io/badge/Docker-25.0-blue?logo=docker" alt="Docker" />	Running the PostgreSQL database
AI Orchestration	<img src="https://img.shields.io/badge/LangChain-0.2-orange?logo=langchain" alt="LangChain" />	Building the agent and managing tools
LLM	<img src="https://img.shields.io/badge/Ollama-0.1-lightgrey?logo=ollama" alt="Ollama" /> & Llama 3	Local, GPU-accelerated language model
Scheduling	<img src="https://img.shields.io/badge/APScheduler-3.10-purple" alt="APScheduler" />	Running proactive monitoring checks
